...
const AddCardCover = ({card, setClickAddCover}) => {
    const [isCover, setIsCover] = useState(card.cardColor === 'white' ? false : true)
    const ref = useOutsideClick(() => {setClickAddCover(false)})
            ...
            <div className={style.cardCoverWrapper} ref={ref}>
                ...
                <div className={style.colorList}>
                    ...
                    <div 
                        ...
                        onClick={(e) => updateColor(e)}></div>
                    {isCover &&
                        <div className={style.removeCover}
                            onClick={removeCover}>
                            Remove cover
                        </div>
                    }
